...
const [fromCurrency, setFromCurrency] = useState("USD");
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-100 to-purple-200">
      <div className="shadow-xl w-full max-w-2xl rounded-lg p-8 bg-white">
        <h1 className="mb-8  text-2xl text-gray-600">Currency Convertor</h1>
        <div className="grid  md:grid-cols-3 gap-6">
         <div className="flex flex-col">
          <label htmlFor="amount" className="mb-1 text-gray-700 font-medium">Amount</label>
          <input type="text"  placeholder="Enter amount" value={amount}
          onChange={(e)=>setAmount(e.target.value)}
          className=" p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" />
         </div>
         <div className="flex flex-col ">
          <label htmlFor="from" className="mb-1 text-gray-700 font-medium">From</label>
          <select name="from" id="from"  className=" p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
         ...
         <div className="flex flex-col ">
          <label htmlFor="to" className="mb-1 text-gray-700 font-medium">To</label>
          <select name="to" id="to"  className=" p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
